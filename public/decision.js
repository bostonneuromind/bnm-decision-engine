...
const I18N = {
  ...
  en: {
    ...
    minutes_suffix: 'min',
    // === beta-guide.html ===
    beta_page_title: 'Beta Guide',
    beta_badge: 'CNA v7 Beta — 5 Clients',
    beta_op_guide_h: 'Beta Operation Guide',
    beta_op_sub: 'Boston Neuromind LLC · 5 Part-time Therapy Clients',
    beta_principles_h: 'Beta Operation Principles',
    beta_principle1: '1. System recommendations are suggestions only — clinician makes final decision',
    beta_principle2: '2. Safety catch (Crisis flag, mandated reporter) always takes priority',
    beta_principle3: '3. Record all outcome data → system learning',
    beta_principle4: '4. If prediction error accumulates, consider mapping matrix adjustment',
    beta_sec1_h: '1. Beta Client Eligibility Criteria',
    inclusion_h: 'Inclusion Criteria',
    incl1: 'Age 18+',
    incl2: 'Learning efficiency / Peak performance / Mild anxiety·depression',
    incl3: 'Able to participate for minimum 8 weeks (4-8 week protocol + 4 week outcome)',
    incl4: 'Communication in Korean or English',
    incl5: 'Able to provide cognitive·biomarker measurements (Polar H10 or Apple Watch, CPT, etc.)',
    exclusion_h: 'Exclusion Criteria',
    excl1: 'Acute psychosis',
    excl2: 'Active suicidal crisis (Columbia SSRS required)',
    excl3: 'Uncontrolled bipolar disorder',
    excl4: 'Suicide attempt within past 6 months',
    excl5: 'Substance dependence (current)',
    beta_sec2_h: '2. Session 1 Workflow (75-105 min)',
    wf1: 'Step 1: Client registration (5 min) — Initials, ID, chief complaint',
    wf2: 'Step 2: Entry Protocol 5 (30 min) — Time estimation, HRV, CPT, N-back, VSR',
    wf3: 'Step 3: Symptom data collection (15 min) — PHQ-9, GAD-7, subjective scores',
    wf4: 'Step 4: Temporal interview (15 min) — v7 NEW — 8 items',
    wf5: 'Step 5: Client goals (10 min) — Area selection, motivation, barriers',
    wf6_pre: 'Run system (5 min) —',
    wf7: 'Result review + client explanation (15 min) — Explain DDE & Decomposition together',
    beta_sec3_h: '3. 4-Week Session Operation',
    eval_by_area: 'Evaluation by area:',
    col_area_label: 'Area',
    col_duration: 'Duration',
    col_per_week: 'Per Week',
    col_progress: 'Progression',
    area_attention: 'Attention',
    area_learning: 'Learning Efficiency',
    area_peak: 'Peak Performance',
    area_anxiety: 'Anxiety Management',
    area_depression: 'Mood Stability',
    duration_4w: '4 weeks',
    duration_8w: '8 weeks',
    sessions_3: '3x',
    sessions_4: '4x',
    sessions_5: '5x',
    prog_complexity: 'Complexity ramp',
    prog_consol: 'Consolidation',
    prog_skill: 'Skill stacking',
    prog_exposure: 'Exposure gradient',
    prog_ba: 'Behavioral activation',
    each_session_h: 'Each Session Structure',
    sess_start: 'Start (5 min): HRV, mood check',
    sess_run: 'Cards (15-60 min): System-recommended or clinician-override',
    sess_end: 'End (5 min): HRV re-measure, OMR',
    beta_sec4_h: '4. Outcome Data Input',
    outcome_after_4w_pre: 'After 4-week session ends, at',
    outcome_after_4w_post: ':',
    oc1: 'Entry Protocol 5 re-measurement (all measures repeated)',
    oc2: 'Clinical 5-axis score evaluation',
    oc3: 'PHQ-9 / GAD-7 re-measurement',
    oc4: 'Self-report (improvement 0-10, satisfaction 0-10)',
    oc5: 'System auto: Adaptive Re-routing (v7) execution',
    beta_sec5_h: '5. Safety Catch (Required)',
    safety_alert_box: 'When crisis signal is caught, system auto-alerts. Clinician must verify:',
    col_crisis_type: 'Crisis Type',
    col_severity: 'Severity',
    col_immediate_action: 'Immediate Action',
    crisis_passive: 'Passive suicidal ideation',
    crisis_active: 'Active suicidal ideation',
    crisis_plan: 'Suicide plan/means',
    crisis_child_abuse: 'Child abuse disclosure',
    sev_moderate: 'moderate',
    sev_high: 'high',
    sev_imminent: 'imminent',
    act_safety_check: 'Safety check',
    act_columbia: 'Columbia SSRS',
    act_911: '911 + do not leave alone',
    act_dcf: 'MA DCF 800-792-5200',
    ma_reporter_label: 'MA Mandated Reporter Duty:',
    ma_reporter_text: 'BCN + PhD = "allied mental health professional" category. Written report required within 48 hours.',
    beta_sec6_h: '6. Data Collection Items',
    data_intro: 'During beta period, collect:',
    data1_l: 'Each session:',
    data1_t: 'Cognitive 5-axis, clinical 5-axis, biomarkers, OMR response',
    data2_l: 'Every 4 weeks:',
    data2_t: 'Outcome (cognitive_after, clinical_after, self-report)',
    data3_l: 'All crisis events:',
    data3_t: 'Auto-saved to crisis_log table',
    data4_l: 'Clinician override:',
    data4_t: 'Reason required (learning signal ×2)',
    data_storage: 'Data stored in Supabase (HIPAA compatible).',
    beta_sec7_h: '7. Feedback Items',
    feedback_intro: 'During beta, verify these patterns:',
    fb1: 'When system recommendation is clinically inappropriate (override frequency)',
    fb2: 'When DDE result does not match client clinical picture',
    fb3: 'UI/UX improvements (input difficulty, result readability)',
    fb4: 'Missing manual items',
    fb5: 'New card requests',
    feedback_email_label: 'Feedback:',
    beta_sec8_h: '8. Post-Beta Plan',
    plan1: 'Analyze prediction error from 5 clients data',
    plan2: 'Adjust mapping matrix weights (config/cognitive_clinical_mapping.yaml)',
    plan3: 'Add new cards (cna_core/card_deck.py)',
    plan4: 'Adjust DDE parameters (update population_priors)',
    plan5: 'Update manual (reflect beta results)',
    all_info_here: 'All information is here:',
    btn_start_assess_arrow: 'Start New Client Assessment →',
    footer_beta: 'Boston Neuromind LLC · CNA v7.0.0 Beta',
    // === feedback.html ===
    fb_badge: 'Beta Feedback',
    fb_title: 'Share Your Experience',
    fb_rating_label: 'Overall Rating',
    fb_category_label: 'Category',
    fb_cat_usability: 'Usability',
    fb_cat_clarity: 'Result Clarity',
    fb_cat_recommendation: 'Recommendation Quality',
    fb_cat_bug: 'Bug/Error',
    fb_cat_other: 'Other',
    fb_recommend_label: 'Would you recommend it to colleagues?',
    fb_yes: 'Yes',
    fb_no: 'No',
    fb_comment_label: 'Details (Optional)',
    fb_comment_ph: 'Share your thoughts freely...',
    fb_submit_btn: 'Submit Feedback',
    fb_no_rating_err: 'Please rate',
    fb_success: '✅ Thank you for your feedback!',
    fb_err_prefix: 'Error:',
    // === consent.html ===
    consent_page_badge: 'Clinical Consent Form',
    consent_page_title: 'Decision Catcher<br>Beta Participation Consent',
    consent_page_sub: 'Boston Neuromind LLC · IRB Standard Consent Form',
    consent_mode_adult: '👤 <strong>Adult Consent:</strong> You sign directly.',
    consent_mode_minor: '🙋 <strong>Minor Assent:</strong> Your assent + consent form emailed to your parent.',
    consent_mode_inperson: '👨‍👧 <strong>In-person Consent:</strong> After your assent, parent signature follows on the same screen.',
    consent_s1_h: '1. Study Overview',
    consent_s1_p: 'This beta program is a non-commercial beta test to evaluate the clinical utility of the <strong>Decision Catcher (CNA v7)</strong> system developed by Boston Neuromind LLC. The system supports clinician decision-making through differential diagnosis, comorbidity decomposition, and adaptive training recommendations.',
    consent_s2_h: '2. Participation Duration & Procedure',
    consent_s2_l1: 'Total 8 weeks (4-8 week protocol + 4 week outcome measurement)',
    consent_s2_l2: 'Initial assessment (60-90 min)',
    consent_s2_l3: 'Weekly progress entry (5-10 min/session)',
    consent_s2_l4: 'Final outcome assessment (60 min)',
    consent_s3_h: '3. Potential Benefits',
    consent_s3_p: 'You may receive an objective assessment of your cognitive/emotional state and personalized training recommendations. However, this system <strong>does not replace your clinician\'s diagnosis</strong>, and system recommendations serve only as a support tool for the clinician\'s final decision.',
    consent_s4_h: '4. Potential Risks',
    consent_s4_p: 'This beta system is a clinical decision support tool, with the following potential risks:',
    consent_s4_l1: 'Possible inaccuracy of system recommendations (beta stage)',
    consent_s4_l2: 'Possible psychological discomfort during assessment',
    consent_s4_l3: 'Possible technical errors in data processing',
    consent_s4_p2: 'To minimize these risks, all decisions are reviewed by your clinician, and crisis situations (suicidal crisis, psychosis, etc.) are immediately reported to the clinician.',
    consent_s5_h: '5. Confidentiality & Data Protection',
    consent_s5_p: 'All your identifying information and clinical data are encrypted and stored according to HIPAA standards. They are not disclosed to third parties without your consent, and for research disclosure, only anonymized data with all identifying information removed is used.',
    consent_s6_h: '6. Right to Withdraw',
    consent_s6_p: 'You may withdraw from this beta program at any time without penalty. Upon withdrawal, all your data will be deleted within 30 days.',
    consent_s7_h: '7. Safety Protocol',
    consent_s7_p: 'The following situations are immediately reported to the clinician (Mandated Reporter obligation):',
    consent_s7_l1: 'Concern of imminent harm to self or others',
    consent_s7_l2: 'Active suicidal ideation or attempt',
    consent_s7_l3: 'Suspected abuse of children, elderly, or disabled persons',
    consent_s8_h: '8. Contact',
    consent_s8_p: 'For questions or concerns about this study, please contact:<br><strong>Boston Neuromind LLC</strong><br>Canton, Massachusetts<br>Email: support@neurocatchers.com',
    consent_check1: 'I have read and understood the above consent form.',
    consent_check2: 'I understand the potential benefits and risks of this beta program, and voluntarily agree to participate.',
    consent_check3: 'I understand I may withdraw at any time without penalty.',
    consent_check4: 'I understand my data is protected per HIPAA standards and will be anonymized for research disclosure.',
    consent_sig_h: '✍️ Your Signature / Assent',
    consent_sig_name_label: 'Name (auto-filled)',
    consent_sig_date_label: 'Date',
    consent_clear_sig_btn: 'Clear Signature',
    consent_submit_btn: 'Agree & Submit',
    consent_submitting: 'Submitting...',
    consent_err_invalid_access: 'Invalid access',
    consent_err_check_all: 'Please check all consent items',
    consent_err_no_sig: 'Please sign',
    consent_err_server: 'Server error',
    ...
    minutes_suffix: '분',
    // === beta-guide.html ===
    beta_page_title: '베타 가이드',
    beta_badge: 'CNA v7 베타 — 5명 클라이언트',
    beta_op_guide_h: '베타 운영 가이드',
    beta_op_sub: 'Boston Neuromind LLC · 파트타임 세라피 클라이언트 5명',
    beta_principles_h: '베타 운영 원칙',
    beta_principle1: '1. 시스템 추천은 제안일 뿐, 임상가가 최종 결정',
    beta_principle2: '2. 안전 catch (Crisis flag, mandated reporter) 항상 우선',
    beta_principle3: '3. 모든 outcome 데이터 기록 → 시스템 학습',
    beta_principle4: '4. 데이터 prediction error 누적되면 매핑 행렬 조정 고려',
    beta_sec1_h: '1. 베타 클라이언트 자격 기준',
    inclusion_h: '포함 기준',
    incl1: '18세 이상',
    incl2: '학습 효율 / 수행 최적화 / 가벼운 불안·우울 영역',
    incl3: '최소 8주 참여 가능 (4-8주 프로토콜 + 4주 outcome)',
    incl4: '한국어 또는 영어 의사소통 가능',
    incl5: '인지·바이오마커 측정 가능 (Polar H10 또는 Apple Watch, CPT 등)',
    exclusion_h: '제외 기준',
    excl1: '급성 정신증',
    excl2: '활성 자살 위기 (Columbia SSRS 필수)',
    excl3: '통제되지 않은 양극성 장애',
    excl4: '최근 6개월 자살 시도력',
    excl5: '약물 의존 (현재)',
    beta_sec2_h: '2. 회기 1 워크플로 (75-105분)',
    wf1: 'Step 1: 클라이언트 등록 (5분) — 이니셜, ID, 주요 호소',
    wf2: 'Step 2: Entry Protocol 5 (30분) — 시간추정, HRV, CPT, N-back, VSR',
    wf3: 'Step 3: 증상 데이터 수집 (15분) — PHQ-9, GAD-7, 주관적 점수',
    wf4: 'Step 4: 시간 정보 인터뷰 (15분) — v7 NEW — 8문항',
    wf5: 'Step 5: 클라이언트 목표 (10분) — 영역 선택, 동기, 장애물',
    wf6_pre: '시스템 실행 (5분) —',
    wf7: '결과 검토 + 클라이언트 설명 (15분) — DDE, Decomposition 함께 설명',
    beta_sec3_h: '3. 4주 회기 운영',
    eval_by_area: '영역별 평가:',
    col_area_label: '영역',
    col_duration: '기간',
    col_per_week: '회/주',
    ...
    prog_exposure: 'Exposure gradient',
    prog_ba: 'Behavioral activation',
    each_session_h: '각 회기 구성',
    sess_start: '시작 (5분): HRV, 기분 체크',
    sess_run: '카드 실행 (15-60분): 시스템 추천 또는 임상가 override',
    sess_end: '종료 (5분): HRV 재측정, OMR',
    beta_sec4_h: '4. Outcome 데이터 입력',
    outcome_after_4w_pre: '4주 회기 종료 후',
    outcome_after_4w_post: '에서:',
    oc1: 'Entry Protocol 5 재측정 (모든 측정 다시)',
    oc2: '임상 5축 점수 평가',
    oc3: 'PHQ-9 / GAD-7 재측정',
    oc4: '자기 보고 (개선 0-10, 만족도 0-10)',
    oc5: '시스템 자동: Adaptive Re-routing (v7) 실행',
    beta_sec5_h: '5. 안전 catch (필수)',
    safety_alert_box: '위기 신호가 catch되면 시스템이 자동 alert. 임상가는 다음을 확인:',
    col_crisis_type: '위기 유형',
    col_severity: 'Severity',
    col_immediate_action: '즉시 조치',
    crisis_passive: '수동적 자살 생각',
    crisis_active: '능동적 자살 생각',
    crisis_plan: '자살 계획/수단',
    crisis_child_abuse: '아동학대 공개',
    sev_moderate: 'moderate',
    sev_high: 'high',
    sev_imminent: 'imminent',
    act_safety_check: '안전 점검',
    act_columbia: 'Columbia SSRS',
    act_911: '911 + 혼자 두지 마세요',
    act_dcf: 'MA DCF 800-792-5200',
    ma_reporter_label: 'MA Mandated Reporter 의무:',
    ma_reporter_text: 'BCN + PhD = "allied mental health professional" 카테고리. 48시간 내 서면 보고 필수.',
    beta_sec6_h: '6. 데이터 수집 항목',
    data_intro: '베타 기간 중 다음을 수집:',
    data1_l: '각 회기마다:',
    data1_t: '인지 5축, 임상 5축, 바이오마커, OMR 응답',
    data2_l: '4주마다:',
    data2_t: 'Outcome (cognitive_after, clinical_after, 자기 보고)',
    data3_l: '모든 위기 이벤트:',
    data3_t: 'crisis_log 테이블 자동 저장',
    data4_l: '임상가 override:',
    data4_t: '이유 필수 기록 (학습 신호 ×2)',
    data_storage: '데이터는 Supabase (HIPAA 호환)에 저장.',
    beta_sec7_h: '7. 피드백 내용',
    feedback_intro: '베타 진행 중, 다음 패턴을 확인:',
    fb1: '시스템 추천이 임상적으로 부적합한 경우 (override 빈도)',
    fb2: 'DDE 결과가 클라이언트 임상과 일치하지 않는 경우',
    fb3: 'UI/UX 개선점 (입력 어려움, 결과 가독성)',
    fb4: '매뉴얼 항목 missing',
    fb5: '새 카드 추가 요청',
    feedback_email_label: '피드백:',
    beta_sec8_h: '8. 베타 후 계획',
    plan1: '5명 데이터로 prediction error 분석',
    plan2: '매핑 행렬 가중치 보정 (config/cognitive_clinical_mapping.yaml)',
    plan3: '새 카드 추가 (cna_core/card_deck.py)',
    plan4: 'DDE 파라미터 보정 (population_priors 갱신)',
    plan5: '매뉴얼 갱신 (베타 결과 반영)',
    all_info_here: '모든 정보가 다음 위치에 있습니다:',
    btn_start_assess_arrow: '새 클라이언트 평가 시작 →',
    footer_beta: 'Boston Neuromind LLC · CNA v7.0.0 베타',
    // === feedback.html ===
    fb_badge: '베타 피드백',
    fb_title: '사용 경험을 들려주세요',
    fb_rating_label: '전체 만족도',
    fb_category_label: '카테고리',
    fb_cat_usability: '사용성',
    fb_cat_clarity: '결과 명확도',
    fb_cat_recommendation: '추천 입력',
    fb_cat_bug: '버그/오류',
    fb_cat_other: '기타',
    fb_recommend_label: '동료에게 추천하시겠어요?',
    fb_yes: '네',
    fb_no: '아니오',
    fb_comment_label: '상세 의견 (선택)',
    fb_comment_ph: '자유롭게 의견을 박아주세요...',
    fb_submit_btn: '입력',
    fb_no_rating_err: '별점을 박아주세요',
    fb_success: '✅ 입력해주셔서 감사합니다!',
    fb_err_prefix: '오류:',
    // === consent.html ===
    consent_page_badge: '임상 동의서',
    consent_page_title: 'Decision Catcher<br>베타 참여 동의',
    consent_page_sub: 'Boston Neuromind LLC · IRB 표준 동의서',
    consent_mode_adult: '👤 <strong>성인 동의:</strong> 본인이 직접 서명합니다.',
    consent_mode_minor: '🙋 <strong>미성년자 Assent:</strong> 본인 동의 + 부모님께 이메일로 동의서 전송됩니다.',
    consent_mode_inperson: '👨‍👧 <strong>현장 동의:</strong> 본인 Assent 후, 부모님 서명도 같은 화면에서 진행됩니다.',
    consent_s1_h: '1. 연구 개요',
    consent_s1_p: '본 베타 프로그램은 Boston Neuromind LLC가 개발한 <strong>Decision Catcher (CNA v7)</strong> 시스템의 임상적 유용성을 평가하기 위한 비영리 베타 테스트입니다. 본 시스템은 감별 진단, 공존 진단 분해, 적응적 훈련 추천을 통해 임상가의 의사결정을 보조합니다.',
    consent_s2_h: '2. 참여 기간 및 절차',
    consent_s2_l1: '총 8주 (4-8주 프로토콜 + 4주 outcome 측정)',
    consent_s2_l2: '초기 평가 1회 (60-90분)',
    consent_s2_l3: '주간 진행 상태 입력 (5-10분/회)',
    consent_s2_l4: '최종 outcome 평가 (60분)',
    consent_s3_h: '3. 잠재적 이익',
    consent_s3_p: '본인의 인지/감정 상태에 대한 객관적 평가 및 개인화된 훈련 추천을 받을 수 있습니다. 그러나 본 시스템은 <strong>임상가의 진단을 대체하지 않으며</strong>, 시스템의 추천은 임상가의 최종 결정에 보조 도구로만 활용됩니다.',
    consent_s4_h: '4. 잠재적 위험',
    consent_s4_p: '본 베타 시스템은 임상 결정 보조 도구이며, 다음의 위험이 있을 수 있습니다:',
    consent_s4_l1: '시스템 추천의 부정확성 가능성 (베타 단계)',
    consent_s4_l2: '평가 과정에서의 심리적 불편감 가능성',
    consent_s4_l3: '데이터 처리상의 기술적 오류 가능성',
    consent_s4_p2: '상기 위험을 최소화하기 위해 모든 결정은 임상가가 최종 검토하며, 위기 상황(자살 위기, 정신증 등) 발생 시 즉시 임상가에게 보고됩니다.',
    consent_s5_h: '5. 비밀 보장 및 데이터 보호',
    consent_s5_p: '본인의 모든 식별 정보 및 임상 자료는 HIPAA 표준에 따라 암호화되어 저장됩니다. 본인의 동의 없이 제3자에게 공개되지 않으며, 연구 목적의 공개 시 모든 식별 정보가 제거된 익명 자료만 사용됩니다.',
    consent_s6_h: '6. 참여 철회 권리',
    consent_s6_p: '본인은 언제든지 어떠한 불이익 없이 본 베타 프로그램에서 철회할 수 있습니다. 철회 시 본인의 모든 자료는 30일 이내에 삭제됩니다.',
    consent_s7_h: '7. 안전 프로토콜 (Safety Protocol)',
    consent_s7_p: '다음 상황 발생 시 즉시 임상가에게 보고됩니다 (Mandated Reporter 의무):',
    consent_s7_l1: '본인 또는 타인에 대한 임박한 위해 우려',
    consent_s7_l2: '활성 자살 사고 또는 자살 시도',
    consent_s7_l3: '아동, 노인, 장애인 학대 의심 시',
    consent_s8_h: '8. 연락처',
    consent_s8_p: '본 연구에 대한 질문이나 우려 사항은 다음으로 연락 주십시오:<br><strong>Boston Neuromind LLC</strong><br>Canton, Massachusetts<br>Email: support@neurocatchers.com',
    consent_check1: '본인은 위 동의서를 읽고 이해했습니다.',
    consent_check2: '본인은 본 베타 프로그램의 잠재적 이익과 위험을 이해하며, 자발적으로 참여에 동의합니다.',
    consent_check3: '본인은 언제든지 철회할 수 있으며, 철회 시 어떠한 불이익도 없음을 이해합니다.',
    consent_check4: '본인은 데이터가 HIPAA 표준에 따라 보호되며, 연구 목적의 공개 시 익명화됨을 이해합니다.',
    consent_sig_h: '✍️ 본인 서명 / Assent',
    consent_sig_name_label: '성명 (자동 입력)',
    consent_sig_date_label: '날짜',
    consent_clear_sig_btn: '서명 지우기',
    consent_submit_btn: '동의 및 제출',
    consent_submitting: '제출 중...',
    consent_err_invalid_access: '잘못된 접근입니다',
    consent_err_check_all: '모든 동의 항목에 체크해주세요',
    consent_err_no_sig: '서명을 박아주세요',
    consent_err_server: '서버 오류',
